# Generated by Powerlevel10k configuration wizard on 2020-05-29 at 03:01 CDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# angled separators, slanted heads, round tails, 2 lines, disconnected, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=033
